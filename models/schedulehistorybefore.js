...
module.exports = (sequelize, DataTypes) => {
  class ScheduleHistoryBefore extends Model {
    /**
    ...
    static associate(models) {
      ScheduleHistoryBefore.belongsTo(models.ScheduleHistory, { foreignKey: 'ScheduleHistoryId' })
      ScheduleHistoryBefore.belongsTo(models.ActivityType, { foreignKey: 'ActivityTypeId' })
    }
  };
  ScheduleHistoryBefore.init({
    ScheduleHistoryId: {
    ...
    sequelize,
    modelName: 'ScheduleHistoryBefore',
    tableName: 'ScheduleHistoryBefore',
    timestamps: false
  });
  return ScheduleHistoryBefore;
};